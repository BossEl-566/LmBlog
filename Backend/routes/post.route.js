...
import { createPost, deletePost, editpost, getAllAuthorPosts, getAllPosts, getPostById, getPublishedPosts, publishPost } from '../controllers/post.controller.js';
...
router.get('/get-post/publised', getPublishedPosts);
